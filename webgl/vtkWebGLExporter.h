...
class VTK_EXPORT vtkWebGLExporter : public vtkObject
{
public:
  static vtkWebGLExporter* New();
  vtkTypeRevisionMacro(vtkWebGLExporter, vtkObject)
  ...
  void exportStaticScene(vtkRendererCollection* renderers, int width, int height, vtkstd::string path);
...
protected:
  ...
  vtkstd::string renderersMetaData;
  bool hasWidget;
