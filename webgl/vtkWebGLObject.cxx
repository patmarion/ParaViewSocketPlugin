...
vtkCxxRevisionMacro(vtkWebGLObject, "$Revision$");
...
unsigned char* vtkWebGLObject::GetBinaryData(int part){return NULL;}
int vtkWebGLObject::GetBinarySize(int part){return 0;}
